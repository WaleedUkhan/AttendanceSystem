...
export default function AdminViewRecords() {
  ...
  return (
    <div className="mx-auto p-4 md:p-6 lg:p-8 bg-gradient-to-b from-gray-900 to-gray-800 text-white rounded shadow-md ">
      ...
      <div className="px-16 my-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 px-5">
          <div className="flex flex-col text-center bg-[#ecf0f1] w-full px-5 py-7">
            <h3 className="text-2xl font-bold mb-2 text-gray-800">{presentDays}</h3>
            <p className="text-lg font-medium text-gray-800">Present Days</p>
          </div>
          <div className="flex flex-col text-center bg-[#ecf0f1] w-full px-5 py-7">
            <h3 className="text-2xl font-bold mb-2 text-gray-800">{absents}</h3>
            <p className="text-lg font-medium text-gray-800">Absent Days</p>
          </div>
          <div className="flex flex-col text-center bg-[#ecf0f1] w-full px-5 py-7">
            <h3 className="text-2xl font-bold mb-2 text-gray-800">{leaves}</h3>
            <p className="text-lg font-medium text-gray-800">Leaves</p>
          </div>
          {/* <div className="flex flex-col text-center bg-[#ecf0f1] w-full px-5 py-7">
          ...
          <div className="flex flex-col text-center bg-[#ecf0f1] w-full px-5 py-7">
            <h3 className={`text-2xl font-bold mb-2 text-gray-800 ${getGradeColor(grade)}`}>{grade}</h3>
        ...
        <tbody>
          {data?.length > 0 ? (
            ...
            <tr>
              <td
                colSpan="7"
                className="px-6 py-4 text-sm text-center text-gray-800"
              >
